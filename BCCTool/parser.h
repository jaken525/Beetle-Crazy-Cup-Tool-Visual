#pragma once
 ...
 // OBJ Parser C++ for BCCTool.
// It can work without a program.
...
public:
	...
	// Parsing a file by path.
	void ObjParse(std::string path, int texture, bool autoTex)
	{
		...
		// Getting a string and processing with definition.
	...
	std::vector<std::string> GetFaces()
	{
		...
		for (int i = 0; i < fx.size(); i++)
		{
			...
			faces.push_back(std::to_string(ft[i]));
		}
...
private:
	...
	// Getting vertices and vertices of normals with type definition.
	...
	// Getting texture number from material name.
