...
namespace BCCTool
{
	...
	public:
		...
		SaveEditor^ saver = gcnew SaveEditor(*currentPath);
...
#pragma region Windows Form Designer generated code
		   void InitializeComponent(void)
		   {
			   ...
			   // label8
			   // 
			   this->label8->Location = System::Drawing::Point(392, 86);
			   this->label8->Name = L"label8";
			   this->label8->Size = System::Drawing::Size(71, 13);
			   this->label8->TabIndex = 11;
			   this->label8->Text = L"Profile Editor";
			   ...
			   this->button6->Location = System::Drawing::Point(392, 10);
			   ...
			   this->label7->Text = L"Map Creator";
			   ...
			   // label5
			   // 
			   this->label5->Location = System::Drawing::Point(469, 86);
			   ...
			   this->button4->Location = System::Drawing::Point(469, 10);
