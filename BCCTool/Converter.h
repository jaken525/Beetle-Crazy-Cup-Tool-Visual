...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Converter::typeid));
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(189, 221);
			...
			this->label1->Location = System::Drawing::Point(12, 213);
			...
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(12, 229);
			...
			this->ClientSize = System::Drawing::Size(262, 264);
	...
	{
		if (IsProcessRunning("beetle.exe"))
			MessageBox::Show("Ñlose the original game before you start.", "Warning", MessageBoxButtons::OK, MessageBoxIcon::Warning);
		else
		{
			isUnpacking = true;
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		{
			this->Text = L"Packer";
			groupBox2->Enabled = !isUnpacking;
		}

		button1->Enabled = !isUnpacking;
		groupBox1->Enabled = !isUnpacking;

		if (isUnpacking)
			label1->Text = msclr::interop::marshal_as<String^>(status);

		progressBar1->Maximum = endPoint;
